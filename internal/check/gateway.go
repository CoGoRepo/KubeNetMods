...
func runGatewayScan(ctx context.Context, client *kube.Client, report *model.Report, opts GatewayOptions) {
	...
	if gatewayAPIMissing(classErr) && gatewayAPIMissing(gatewayErr) && gatewayAPIMissing(routeErr) {
	...
	scanner.scanHTTPRoutes(ctx, client, routes, gateways, refGrants, serviceCache, serviceErrCache, endpointReadyCache, endpointErrCache)
